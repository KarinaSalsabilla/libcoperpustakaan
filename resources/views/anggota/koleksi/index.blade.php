...
<head>
  ...
  <style>
    ...
    *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
    ...
    .book-card:nth-child(1){animation-delay:.03s}.book-card:nth-child(2){animation-delay:.06s}
    .book-card:nth-child(3){animation-delay:.09s}.book-card:nth-child(4){animation-delay:.12s}
    .book-card:nth-child(5){animation-delay:.15s}.book-card:nth-child(6){animation-delay:.18s}
    .book-card:nth-child(7){animation-delay:.21s}.book-card:nth-child(8){animation-delay:.24s}
   ...
   .lc-cover{width:56px;height:84px;flex-shrink:0;border-radius:3px 8px 8px 3px;overflow:hidden;position:relative;box-shadow:-2px 3px 10px rgba(37,99,235,.15)}
        ...
        <div class="sidebar-collapsible" id="sidebarCollapsible">
          ...
          <div class="fs-body">
            ...
            <div class="fs-section">
              ...
              <div class="cat-list">
                <button class="cat-item active" data-cat="semua">Semua<span class="cat-count">{{ $ebooks->total() }}</span></button>
